...
<html lang="en">
    ...
    <header class="header-lesaanbod">
                ...
                <ul class="nav-midden">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="lidmaatschapweiziging.php">lidmaatschapweiziging</a>
                        </div>
                    </div> 
                    <li><a href="../contact/contact.php" class="contact">contact</a></li>
                </ul>              
            </nav>
            <li><a href="../inlog/login.php" class="login"><i class="fa-solid fa-user"></i></i></i></a></li>
                ...
                <!-- sidebar -->
        <section>
            <div class="sidenav-lidmaatschap">
                <a href="aanmelden.php" class="aanmelden">Aanmelden</a>
                <br>
                <a href="afmelden.php" class="afmelden">Afmelden</a>
                <br>
                <a href="contributie.php" class="contributie">Contributie</a>
                <br>
                <a href="lidmaatschapweiziging.php" class="lidmaatschapweiziging">Lidmaatschap weiziging</a>
            </div>
        </section>
